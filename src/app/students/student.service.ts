...
export class StudentService {
  private baseApiUrl = 'https://localhost:44313';
...
// the profileimage inside the braces should have the same name as mentioned in the student controller api Inside the method of UploadImage ---- IFormFile profileImage
